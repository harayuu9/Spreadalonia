    ...
    internal class Table : Control
    {
        ...
        public override void Render(DrawingContext context)
        {
            ...
            using (context.PushTransform(Matrix.CreateTranslation(-1, -1)))
            {
                ...
                {
                    this.Container.SetScrollbarMaximum(
                        actualWidth + startWidth - this.Bounds.Width + GetWidth(left + width),
                        actualHeight + startHeight - this.Bounds.Height + GetHeight(top + height));
                });
            }
        }
    }
